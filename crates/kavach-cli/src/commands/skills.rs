...
fn builtin_skills() -> Vec<Skill> {
    vec![
        Skill {
            name: "commit".into(),
            category: "git".into(),
            description: "Create git commit with conventional format".into(),
            triggers: vec!["/commit".into(), "commit changes".into()],
        ...
        Skill {
            name: "review-pr".into(),
            category: "git".into(),
            description: "Review pull request changes".into(),
            triggers: vec!["/review-pr".into(), "review pr".into()],
            commands: vec!["gh pr view".into(), "gh pr diff".into()],
            path: String::new(),
            research: Vec::new(),
            patterns: Vec::new(),
        },
        Skill {
            name: "create-pr".into(),
            category: "git".into(),
            description: "Create pull request".into(),
            triggers: vec!["/create-pr".into(), "create pr".into()],
            commands: vec!["gh pr create".into()],
            path: String::new(),
            research: Vec::new(),
            patterns: Vec::new(),
        },
        Skill {
            ...
            description: "Initialize session with context".into(),
            triggers: vec!["/init".into(), "start session".into()],
            commands: vec!["kavach session init".into()],
            path: String::new(),
            research: Vec::new(),
            patterns: Vec::new(),
        },
        Skill {
            ...
            triggers: vec!["/status".into(), "show status".into()],
            commands: vec!["kavach status".into()],
            path: String::new(),
            research: Vec::new(),
            patterns: Vec::new(),
        },
        Skill {
            ...
            description: "Query memory bank".into(),
            triggers: vec!["/memory".into(), "memory bank".into()],
            commands: vec!["kavach memory bank".into()],
            path: String::new(),
            research: Vec::new(),
            patterns: Vec::new(),
        },
        Skill {
            name: "kanban".into(),
            category: "memory".into(),
            description: "Show kanban dashboard".into(),
            triggers: vec!["/kanban".into(), "show kanban".into()],
            commands: vec!["kavach memory kanban".into()],
            path: String::new(),
            research: Vec::new(),
            patterns: Vec::new(),
        },
        Skill {
            ...
            description: "Plan implementation approach".into(),
            triggers: vec!["/plan".into(), "create plan".into()],
            commands: vec!["EnterPlanMode".into()],
            path: String::new(),
            research: Vec::new(),
            patterns: Vec::new(),
        },
        Skill {
            ...
            triggers: vec!["/explore".into(), "explore code".into()],
            commands: vec!["Task(Explore)".into()],
            path: String::new(),
            research: Vec::new(),
            patterns: Vec::new(),
        },
        Skill {
            ...
            triggers: vec!["/build".into(), "build project".into()],
            commands: vec!["make".into(), "go build".into(), "npm run build".into()],
            path: String::new(),
            research: Vec::new(),
            patterns: Vec::new(),
        },
        Skill {
            ...
            triggers: vec!["/test".into(), "run tests".into()],
            commands: vec!["go test".into(), "npm test".into(), "pytest".into()],
            path: String::new(),
            research: Vec::new(),
            patterns: Vec::new(),
        },
