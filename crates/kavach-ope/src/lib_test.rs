...
fn lcb_is_value_minus_z_times_se() {
    let est = Estimate { value: 0.8, std_error: 0.1, n: 100 };
...
fn infinite_se_yields_neg_infinity_lcb() {
    ...
    let est = Estimate { value: 5.0, std_error: f64::INFINITY, n: 1 };
...
fn a_higher_lcb_policy_beats_a_lower_one() {
    ...
    let incumbent = Estimate { value: 0.5, std_error: 0.05, n: 200 };
    let candidate = Estimate { value: 0.7, std_error: 0.04, n: 200 };
    let z = 1.96;
    assert!(
